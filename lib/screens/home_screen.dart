...
// NÚT ĐĂNG XUẤT
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              onPressed: () async {
                // 1. Thực hiện Đăng xuất Firebase/Auth Service
                ...
                // 3. Điều hướng về trang Đăng nhập & xóa sạch lịch sử chuyển trang
                Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(
                    builder: (context) => const LoginScreen(), // Thay 'LoginScreen()' bằng tên Class trang đăng nhập của bạn
                  ),
                      (route) => false, // Xóa hết tất cả các route cũ
                );
              },
              child: const Row(
                mainAxisAlignment: MainAxisAlignment.center,
